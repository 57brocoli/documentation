                            ...
                            <>
                                ...
                                <section>
                                    ...
                                    <article>
                                        ...
                                        <div className='py-3'>
                                            <p>{data.section[1].partieA.content.puces[0].titre}</p>
                                            <img src={navDescktop} alt="bar de navigation bureau" className='py-2'/>
                                            <p>{data.section[1].partieA.content.puces[0].text}</p>
                                        </div>
                                        <div className='py-3'>
                                            <p>{data.section[1].partieA.content.puces[1].titre}</p>
                                            <img src={navSmartpphone} alt="bar de navigation phone" className='py-2'/>
                                            <p>{data.section[1].partieA.content.puces[1].text}</p>
                                        </div>
                                    </article>
                                    ...
                                    <article>
                                        ...
                                        <div className='py-3'>
                                            ...
                                            <img src={couche1} alt="1er couche de navigation" className='py-2' style={{width:800}}/>
