...
import Page1 from './SousComposants/Page1'
...
function Données() {
    ...
    if (data.section) {
        ...
        var home = données.content.composants.filter(sec=>sec.nom === "Home.jsx").at(0)
        var page1 = données.content.composants.filter(sec=>sec.nom === "Page1.jsx").at(0)
        var page2 = données.content.composants.filter(sec=>sec.nom === "Page2.jsx").at(0)
    }

    const filtre = ['1er couche', '2nd couche', '3eme couche']
    const [filtreActive, setFiltreActive] = useState('1er couche')
            ...
            {données &&
                <motion.div initial={{opacity:0}} animate={{opacity:1}} transition={{duration: 0.2}}>
                    ...
                    <AnimatePresence mode="wait">
                        ...
                        >
                        {filtreActive === "1er couche" && <Home home={home}/>}
                        {filtreActive === "2nd couche" && <Page1 o={page1}/>}
