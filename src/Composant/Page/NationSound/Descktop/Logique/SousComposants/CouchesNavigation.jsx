                ...
                <article>
                    ...
                    <div className='my-6'>
                        ...
                        <div>
                            ...
                            <p>Pour avoir plus de details sur le rendu des pages, <Link to={'/nationsound/desktop/maquettes'} className='visited:text-purple-600'>les maquettes grapiques</Link> detailent leurs aspect visuel</p>
                        </div>
                    </div>
                </article>
            </>
