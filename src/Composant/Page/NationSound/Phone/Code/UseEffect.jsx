        ...
        <main className='background pt-20 px-10'>
            ...
            {data.section &&
                <motion.div initial={{opacity:0}} animate={{opacity:1}} transition={{duration: 0.2}}>
                    <h2 className='text-2xl font-bold mb-10 orange'>{data.section[1].titre}</h2>
                    ...
                    <p>Import :</p>
                    <img src={data.section[1].content.imgImport} className='rounded border-2 my-2 h-10' alt="import du fichier" />
                    ...
                    <article>
                        ...
                        {data.section &&
                            data.section[1].content.utilisation.map((cas, index)=>{
                                return(
