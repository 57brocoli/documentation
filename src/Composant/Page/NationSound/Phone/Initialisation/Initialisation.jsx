...
import ReactNative from './SousComposants/ReactNative'
...
function Initialisation() {
    ...
    const filtre = ["Instalation de ReactNative", "Initalisation de l'environement", "Instalation des Packages"]
    const [filtreActive, setFiltreActive] = useState('Instalation de ReactNative')
                    ...
                    {data.section &&
                        <>
                            ...
                            <AnimatePresence mode="wait">
                                ...
                                >
                                {filtreActive === "Instalation de ReactNative" && <ReactNative data={data} setFiltreActive={setFiltreActive}/>}
