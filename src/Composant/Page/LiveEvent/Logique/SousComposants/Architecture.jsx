                ...
                <>
                    ...
                    <article>
                        ...
                        <div className='lg:flex py-2'>
                            <img src={data.section[1].partieA.content.img} alt="racinde du projet" className='rounded border-2'/>
                    ...
                    <article>
                        ...
                        <img src={data.section[1].partieB.content.img} className='me-5 rounded border-2' style={{width:300}} alt="dossier src"/>
                        <div className='py-2'>
                                                ...
                                                <div className='lg:flex me-3'>
                                                    {puce.img &&
                                                        puce.img.map((img, index)=>{
                                                            return(
                                                                <div key={index} style={{minWidth:250}}>
                                                                    <img src={img} alt="image du fichier" className='mt-2 rounded border-2'/>
                                                                </div>
                    ...
                    <article>
                        <h3 className='text-xl font-bold my-3 jaune'>{data.section[1].partieC.titre}</h3>
                        {data.section[1].partieC.content.introduction.map((intro, index)=>{
                            return(
                                <p key={index} className='pb-2 '>{intro}</p>
                            )
                        })}
                        <img src={data.section[1].partieC.content.img} className='me-5 rounded border-2' style={{width:300}} alt="dossier src"/>
                        <div className='py-2'>
