...
function AdminNS({data}) {
    return (
        <article className='my-5'>
            <h3 className='text-xl font-semibold my-3 jaune'>{data.section[1].partieD.titre}</h3>
            <p>{data.section[1].partieD.content.introduction}</p>
            {data.section[1].partieD.content.puces.map((puce, index)=>{
                return(
